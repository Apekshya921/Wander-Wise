...
toast.error(error.message||"Eror while deleting trip")
console.log(error)
  }
}
  return (
    <div className='px-20 py-24'>
      <Card>
        <CardHeader className={""}>
          <CardTitle>Select a trip to view baggages</CardTitle>
          <CardDescription>Click view baggage button to see trip baggages</CardDescription>
